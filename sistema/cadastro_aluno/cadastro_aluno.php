...
//fim da busca
if($op == 'excluir'){
$query  = " delete from cadastro_aluno ";
$query .= " where codigo = '$cod'";
mysql_query($query);
logs('cadastro_aluno','delete',$cod,$query);
echo "<script>window.location.href='cadastro_aluno.php?id=$id'</script>";
 } 
...
echo "  <tr>";
echo "    <td colspan='5' class='titulos_modelos'>Alunos";
echo "         <td  align='right'>&nbsp;";
...
echo "<a href='cadastro_aluno_form.php?op=novo' class='paginacao'>Não foram encontrados registros para os dados informados, para incluir como novo Clique aqui</a>";
}else{
echo "<a href='cadastro_aluno_form.php?op=novo' class='paginacao'>Clique aqui para incluir novo registro.</a>";
}
echo "</tr>";
echo "</table>";
if ($totreg){	
...
echo "<td width='35'><a href=cadastro_aluno_form.php?cod=$codigo&op=editar&id=$id><img src='../img/drafts.gif'  border='0' alt='Editar' width='15' height='16'></a>";

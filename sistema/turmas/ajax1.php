<script language="JavaScript">
   ...
   function Dados1(valor) {
	  ...
	  if(ajax) {
		 ...
		 document.forms[0].codigo_disciplina.options.length = 1;

		 idOpcao  = document.getElementById("opcoes");
		 
	     ajax.open("POST", "xml1.php", true);
   ...
   function processXML1(obj){
      //pega a tag cidade
      var dataArray   = obj.getElementsByTagName("disciplinas");
	  ...
	  if(dataArray.length > 0) {
         ...
         for(var i = 0 ; i < dataArray.length ; i++) {
			...
			var novo = document.createElement("option");
				...
				document.forms[0].codigo_disciplina.options.add(novo);
		 }
	  }
	  else {

...
mysql_select_db("cieceja_nacoes") or die('Erro no banco');
...
while($d = mysql_fetch_object($result)){
	...
	if($d->operacao != 'DELETE'){
		...
		$com = "replace into cieceja_nacoes.".$d->tabela." (".@implode(",",$fieldnames).") values ('".@implode("','",$D)."')";

	}else{
		$com = "delete from cieceja_nacoes.".$d->tabela." where codigo = '".$d->codigo."'";
	}

...
echo "\n<tr><td width='10'><input type='radio' name='codigo_turma' id='codigo_turma' value='".$dados->codigo."' checked>";
echo "\n<td><b>Data do Exame:</b><br><input type='text' name='data_final' value='' >";

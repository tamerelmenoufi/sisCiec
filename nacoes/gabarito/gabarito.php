...
if($chave_busca){
$complemento = " where turmas.codigo like '%$chave_busca%'";
}else {$complemento = '';}
//fim da busca
if($op == 'excluir'){
$query  = " delete from gabarito ";
$query .= " where codigo = '$cod'";
mysql_query($query);
logs('gabarito','delete',$cod,$query);
echo "<script>window.location.href='gabarito.php?id=$id'</script>";
 } 

//novo
$query1  = " select ";
$query1 .= "gabarito.codigo,";
$query1 .= "turmas.codigo, ";
$query1 .= "gabarito.ordem, ";
$query1 .= "gabarito.resposta";
$query1 .= " from gabarito";
$query1 .= " left join turmas on gabarito.turma=turmas.codigo";
$query1 .= " $complemento";
...
echo "  <tr>";
echo "    <td colspan='3' class='titulos_modelos'>Gabarito";
echo "         <td  align='right'>$formulario";
echo "      <tr><td colspan='4'  align='right'> <a href='gabarito_form.php?op=novo' class='paginacao'><img src='../img/new.gif' width='16' height='16' border='0'>";
...
echo "<td class='titulo_f'>$turma";
echo "<td class='titulo_f'>$ordem";
if($resposta == 'A'){ $resposta='A';}
if($resposta == 'B'){ $resposta='B';}
if($resposta == 'C'){ $resposta='C';}
if($resposta == 'D'){ $resposta='D';}
if($resposta == 'E'){ $resposta='E';}
echo "<td class='titulo_f'>$resposta";
echo "<td width='35'><a href=gabarito_form.php?cod=$codigo&op=editar&id=$id><img src='../img/drafts.gif'  border='0' alt='Editar' width='15' height='16'></a>";

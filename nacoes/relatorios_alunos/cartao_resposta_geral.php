...
<script language='javascript'>
   ...
   function imprimir_declaracao(val){
      var w = window.open("./cartao_resposta.php?cod=" + val + '&cod1=<?=$cod?>',"declaracao");
	  w.focus();
	  return false;
   }
...
<table border='0'  cellpadding='0' cellspacing='0' width='100%'><tr><td width='18%' class='font_branca'>RELATÓRIOS</td><td width='90%'></td><tr>
  <td colspan='2'  class='bg_busca_aluno' height='50'>&nbsp;&nbsp;CART&Atilde;O RESPOSTA </td>
</table>
<?php

$sql = "select a.*,b.nome,c.codigo as cod_mat,c.nota,c.frequencia,c.situacao,concat(d.descricao,' ',c.observacao) as disc,d.codigo as cod_disc,concat(e.descricao,' (',e.tipo,')') as disc_curso from turmas a 
...
echo "<td><input type='image' src='../img/6.gif' title='Imprimir declaração de Matrícula' onclick=\"return imprimir_declaracao('$dados->cod_disc');\">";

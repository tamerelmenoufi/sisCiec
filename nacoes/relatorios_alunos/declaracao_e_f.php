...
include("../includes/data_ext.inc.php");
	...
	$query = "select a.nome,a.rg,a.rg_orgao,b.descricao, b.codigo as cursos, c.data_exame from cadastro_aluno a " 
		   ...
		   . " where a.codigo = '$cod' and b.descricao like '%Ensino fundamental%' order by c.data_exame desc limit 0,1";
	$result = mysql_query($query);
//	echo $query;
	$dados = mysql_fetch_object($result);

	if(!mysql_num_rows($result)){
		echo "<br><br><br><br><br><br><center>Aluno N„o esta matriculado para o Ensino Fundamental<br><br><a href='javascript:window.close()'>Voltar</a></center>"; exit;
	}

...
if($chave_busca){
$complemento = " where cadastro_cursos.descricao like '%$chave_busca%' or cadastro_disciplinas.descricao like '%$chave_busca%'";
}else {$complemento = '';}
//fim da busca
if($op == 'excluir'){
$query  = " delete from cadastro_disciplinas ";
$query .= " where codigo = '$cod'";
mysql_query($query);
logs('cadastro_disciplinas','delete',$cod,$query);
echo "<script>window.location.href='cadastro_disciplinas.php?id=$id'</script>";
 } 

//novo
$query1  = " select ";
$query1 .= "cadastro_disciplinas.codigo,";
$query1 .= "cadastro_cursos.descricao, ";
$query1 .= "cadastro_cursos.tipo, ";
$query1 .= "cadastro_disciplinas.descricao";
$query1 .= " from cadastro_disciplinas";
$query1 .= " left join cadastro_cursos on cadastro_disciplinas.codigo_curso=cadastro_cursos.codigo";
$query1 .= " $complemento";
...
echo "  <tr>";
echo "    <td colspan='2' class='titulos_modelos'>Disciplinas";
echo "      <tr><td colspan='3'  align='right'>";

echo "<table border='0'  cellpadding='0' cellspacing='0' width='100%'><tr><td width='23%' class='font_branca'>CURSO / DESCRICAO</td><td width='90%'></td><tr><td colspan='2'  class='bg_busca_aluno' height='50'>&nbsp;&nbsp;$formulario </td></table>";

echo " <a href='cadastro_disciplinas_form.php?op=novo' class='paginacao'><img src='../img/new.gif' width='16' height='16' border='0'>";
echo "Nova disciplina</a>";
echo "</table>";
if ($totreg){	
...
echo "<td width='35'><a href=cadastro_disciplinas_form.php?cod=$codigo&op=editar&id=$id><img src='../img/drafts.gif'  border='0' alt='Editar' width='15' height='16'></a>";

...
$complemento = " where cadastro_professor.nome like '%$chave_busca%' or cadastro_professor.cpf like '%$chave_busca%' or cadastro_professor.rg like '%$chave_busca%' or cadastro_professor.telefone like '%$chave_busca%' or cadastro_professor.email like '%$chave_busca%'";
}else {$complemento = '';}
//fim da busca
if($op == 'excluir'){

mysql_query("delete from professor_disciplina where codigo_professor = '".$cod."'");

$query  = " delete from cadastro_professor ";
$query .= " where codigo = '$cod'";
mysql_query($query);
logs('cadastro_professor','delete',$cod,$query);
echo "<script>window.location.href='cadastro_professor.php?id=$id'</script>";
 } 

//novo
$query1  = " select ";
$query1 .= "cadastro_professor.codigo,";
$query1 .= "cadastro_professor.nome, ";
$query1 .= "cadastro_professor.cpf, ";
$query1 .= "cadastro_professor.rg, ";
$query1 .= "cadastro_professor.telefone, ";
$query1 .= "cadastro_professor.email";
$query1 .= " from cadastro_professor";
$query1 .= " $complemento";
...
echo "  <tr>";
echo "    <td colspan='5' class='titulos_modelos'>Professores";
echo "         <td  align='right'>&nbsp;";
echo "      <tr><td colspan='6'  align='left'><table border='0'  cellpadding='0' cellspacing='0' width='100%'><tr><td width='12%' class='font_branca'>RG / CPF</td><td width='90%'></td><tr><td colspan='2'  class='bg_busca_aluno' height='50'>&nbsp;&nbsp;$formulario </td></table>";
echo "<tr><td colspan='6' class='paginacao' align='right'><div align='right'><a href='cadastro_professor_form.php?op=novo' class='paginacao'><img src='../img/new.gif' width='16' height='16' border='0'> Novo professor</a></div></tr>";
echo "</table>";
if ($totreg){	
...
echo "<td width='35'><a href=cadastro_professor_form.php?cod=$codigo&op=editar&id=$id><img src='../img/drafts.gif'  border='0' alt='Editar' width='15' height='16'></a>";

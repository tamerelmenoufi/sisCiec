...
$complemento = " where usuarios.login != 'admincnery' and ( usuarios.nome like '%$chave_busca%' or usuarios.telefone like '%$chave_busca%' or usuarios.email like '%$chave_busca%')";
}else {$complemento = " where usuarios.login != 'admincnery'";}
//fim da busca
if($op == 'excluir'){
$query  = " delete from usuarios ";
$query .= " where codigo = '$cod'";
mysql_query($query);
logs('usuarios','delete',$cod,$query);
echo "<script>window.location.href='usuarios.php?id=$id'</script>";
 } 

//novo
$query1  = " select ";
$query1 .= "usuarios.codigo,";
$query1 .= "usuarios.nome, ";
$query1 .= "usuarios.email, ";
$query1 .= "usuarios.telefone, ";
$query1 .= "usuarios.situacao";
...
echo "  <tr>";
echo "    <td colspan='5' class='titulos_modelos'>Usuários";
echo "         <td  align='right'>&nbsp;";
echo "      <tr><td colspan='6'  align='left'><table border='0'  cellpadding='0' cellspacing='0' width='100%'><tr><td width='12%' class='font_branca'>Nome / Email / Telefone</td><td width='30%'></td><tr><td colspan='2'  class='bg_busca_aluno' height='50'>&nbsp;&nbsp;$formulario </td></table>";
echo "<tr><td colspan='6' class='paginacao' align='right'><div align='right'><a href='usuarios_form.php?op=novo' class='paginacao'><img src='../img/new.gif' width='16' height='16' border='0'> Novo professor</a></div></tr>";
echo "</table>";
if ($totreg){	
...
if($situacao == 1){ $situacao = 'Ativo'; }else{ $situacao = 'Bloqueado'; }
echo "<td class='titulo_f'>$situacao";
echo "<td width='35'><a href=usuarios_form.php?cod=$codigo&op=editar&id=$id><img src='../img/drafts.gif'  border='0' alt='Editar' width='15' height='16'></a>";

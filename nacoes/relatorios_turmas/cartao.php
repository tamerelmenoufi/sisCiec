...
$query = "select codigo from matricula where codigo_turma='$cod'";
$result = mysql_query($query);
$numero_de_paginas = mysql_num_rows($result);
$i=0;
while(list($cod) = mysql_fetch_row($result)){
  $z = false;
$sql = "select a.*,
			   f.cci,
			   b.nome,
		...
		left join cadastro_aluno f on c.codigo_aluno=f.codigo 
				where c.codigo='$cod' and c.codigo_escola='$conf[codigo_curso]'";
              ...
              <tr>
                <td height="50" colspan="5" class="borda_tabela"><table width="700" height="19"  border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td><div align="center"><span class="arial16">Fone: 3236-4048<br>
                        </span><span class="arial16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3087-5118</span><br>
                        <span class="arial16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3632-0539</span></div></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
...
$sqlm = "select a.*,
		...
		left join cadastro_cursos e on a.codigo_curso=e.codigo 
		left join cadastro_aluno f on c.codigo_aluno=f.codigo 
				where c.codigo_aluno='$dados->cod_mat' and c.codigo_escola='$conf[codigo_curso]' and c.situacao='MT'";
                ...
                <td height="100" colspan="5" class="borda_tabela"><table width="100%"  border="0" cellspacing="0" cellpadding="7">
                  <tr>
                    ...
                    <td width="32%" align="left" valign="top" class="borda_left"><p class="arial11">IMPORTANTE - LEIA<br>
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;-Declara&ccedil;&otilde;es R$ 10,00 - 10 dias &uacute;teis<br>
                      &nbsp;&nbsp;&nbsp;&nbsp;-Atestado de elimina&ccedil;&atilde;o R$ 15,00 - 10 dias &uacute;teis<br>
                      &nbsp;&nbsp;&nbsp;&nbsp;-Certificado R$ 30,00 - data estabelecida pelo coordenador.</p></td>
                  </tr>
                  <tr>
                    <td class="arial11">Local das provas -<span class="arial14"> ITEPES Rua Juar&aacute; No 20 (&quot;Maromba&quot;) - Chapada<br>
          ...
          <tr>
            <td>
                  <table width="700" cellpadding="0" cellspacing="0" class="borda_tabela">
                    ...
                    <tr> 
                      <td colspan="5" class="borda_tabela">
                        <p align="center" class="arial21">C.C.I. - Cart&atilde;o 
                          de Confirma&ccedil;&atilde;o de Inscri&ccedil;&atilde;o                        </p>                      </td>
                    </tr>
                    <tr> 
                    ...
                    <tr> 
                      <td height="57" colspan="5" class="borda_tabela"><table width="700"  border="0" cellpadding="1" cellspacing="0">
                        <?php

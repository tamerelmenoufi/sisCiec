...
$complemento = " where cadastro_cursos.descricao like '%$chave_busca%'";
}else {$complemento = '';}
//fim da busca
if($op == 'excluir'){
$query  = " delete from cadastro_cursos ";
$query .= " where codigo = '$cod'";
mysql_query($query);
logs('cadastro_cursos','delete',$cod,$query);
echo "<script>window.location.href='cadastro_cursos.php?id=$id'</script>";
 } 

//novo
$query1  = " select ";
$query1 .= "cadastro_cursos.codigo,";
$query1 .= "cadastro_cursos.descricao,";
$query1 .= "cadastro_cursos.tipo";
$query1 .= " from cadastro_cursos";
$query1 .= " $complemento";
...
echo "  <tr>";
echo "    <td colspan='1' class='titulos_modelos'>Cursos";
...
echo " <a href='cadastro_cursos_form.php?op=novo' class='paginacao'><img src='../img/new.gif' width='16' height='16' border='0'>";
echo "Novo curso</a>";
echo "</table>";
...
echo "<td class='titulo_f'>$tipo";
echo "<td width='35'><a href=cadastro_cursos_form.php?cod=$codigo&op=editar&id=$id><img src='../img/drafts.gif'  border='0' alt='Editar' width='15' height='16'></a>";

...
echo "  <tr>";
echo "    <td colspan='5' class='titulos_modelos'>Relatórios de Alunos";
echo "         <td  align='right'>&nbsp;";
...
echo "<input type='image' src='../img/1.gif' title='Visualizar Declaração' onclick=\"return imprimir_inscricao('comprovante.php','$codigo');\">";
